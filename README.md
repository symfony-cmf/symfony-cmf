...
The MenuBundle makes use of the KnpMenuBundle (see http://github.com/knplabs/KnpMenuBundle for installation and configuration). If you want to use menus you need to add the KnpMenuBundle to your vendors.
